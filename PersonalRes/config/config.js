var config = {
    ...
    */  
    ...
    work: [
        //如果您内有工作经历，您可以采取下列写法
        ["2022/10/24 — 2022/11/5", "<br>华杉科技实习生",
            "<p><strong>华杉科技</strong></p>" +
            "<p>2022年下半年，作为应届毕业生，需要参加毕业实习，用以培养学生将书本知识应用于实际的能力，经过两周的实习培训，掌握了更多的web应用知识。</p>" +
            "<p>2022年下半年，作为应届毕业生，需要参加毕业实习，用以培养学生将书本知识应用于实际的能力，经过两周的实习培训，掌握了更多的web应用知识。</p>"
        ]
    ],
     ...
     */
    others: [
        ["2021-05-27", "第十三届蓝桥杯大学生B组省三等奖", "大三上学期，我选择不再摆烂，参与第十三届蓝桥杯大学生B组，然而由于之前的懈怠，仅取得省级二等奖。"]
    ],
     ...
     */
    icon: [
        ["./svg/LeetCode.svg", "https://leetcode.cn/u/upbeat-pareeyn/", "我的力扣主页"],
        ["./svg/github.svg", "https://https://github.com/Acedia0414", "我的GitHub主页"],
        ["./svg/博客.svg", "https://www.lanqiao.cn/users/1890375/", "我的蓝桥杯"]
    ],
